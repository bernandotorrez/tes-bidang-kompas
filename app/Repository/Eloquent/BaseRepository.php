...
class BaseRepository implements BaseInterface
{
    ...
    public function all()
    {
        return $this->model->orderBy($this->orderBy['by'], $this->orderBy['order'])->all();
    }
    ...
    {
        return $this->model->select('*')->where('status', '1')->orderBy($this->orderBy['by'], $this->orderBy['order'])->get();
    }
    ...
    {
        return DB::table($viewName)->select('*')->where('status', '1')->orderBy($this->orderBy['by'], $this->orderBy['order'])->get();
    }
